"""autogenerated by genmsg_py from DynObsTrajectory.msg. Do not edit."""
...
class DynObsTrajectory(roslib.message.Message):
  _md5sum = "156a490125c0df31fa6557eb672e88ef"
  _type = "dynamic_obs_msgs/DynObsTrajectory"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#a dynamic obstacle trajectory
...
"""
  __slots__ = ['probability','exists_after','points']
  _slot_types = ['float64','bool','geometry_msgs/PoseWithCovarianceStamped[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       probability,exists_after,points
    ...
    """
    if args or kwds:
      super(DynObsTrajectory, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.probability is None:
        self.probability = 0.
      if self.exists_after is None:
        self.exists_after = False
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.exists_after = bool(self.exists_after)
      start = end
      end += 4
